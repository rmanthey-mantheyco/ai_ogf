...
## X.X.X.9 Cross‑References

### **Cross‑Reference Rules (Template v1.4)**

Cross‑references must reflect **true dependencies**, not a list of all documents.

A cross‑reference should be included **only if**:

1. **This practice depends on another control**  
   (e.g., 7.2.x depends on 6.2.x and 6.3)

2. **Another control depends on this practice**  
   (e.g., 6.2.4 supports 7.2.x destructive‑action controls)

3. **The controls govern the same domain**  
   (identity, workflows, infrastructure, continuity)

4. **The controls must be implemented together**  
   (e.g., permission scope + decision authority + escalation triggers)

A cross‑reference should **NOT** be included if:

- the relationship is merely conceptual  
- the controls share a theme but not a dependency  
- the controls do not influence each other’s implementation  
- it would cause “reference bloat” or noise  
